...
function setupAPIButtons(){
	...
	FWDPageSimpleButton.setPrototype();
	vimeoButton = new FWDPageSimpleButton("set vimeo source", "#FFFFFF", "#000000",  "#000000", "#FFFFFF");
	vimeoButton.getStyle().marginRight = "14px";
	vimeoButton.getStyle().marginTop = "6px";
	vimeoButton.addListener(FWDPageSimpleButton.CLICK, vimeoClickHandler);
	...
	apiButtonsHolder_el.appendChild(vimeoButton.screen);
...
function setYoutubeClickHandler(){
	player1.setVideoSource("https://www.youtube.com/watch?v=ZT4PtvgakLU");
}
...
function setMp4ClickHandler(){
	player1.setVideoSource("content/videos/desktop.mp4, content/videos/mobile.mp4");
}
